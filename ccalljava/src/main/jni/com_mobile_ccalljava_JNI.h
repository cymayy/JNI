...
#include <jni.h>
/* Header for class com_mobile_ccalljava_JNI */

#ifndef _Included_com_mobile_ccalljava_JNI
#define _Included_com_mobile_ccalljava_JNI
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_mobile_ccalljava_JNI
 * Method:    callbackAdd
 * Signature: ()V
 */
